            ...
            <form onSubmit={handleSubscribe} className="flex w-full max-w-md items-center gap-2">
              <div className="relative w-full">
                <input
                  ...
                  className="w-full rounded-full border border-cinema-gray bg-cinema-charcoal/40 px-5 py-2.5 pl-11 text-sm text-cinema-popcorn placeholder-cinema-gray outline-none focus:border-cinema-gold focus:ring-1 focus:ring-cinema-gold/30"
                />
                <Mail className="absolute left-4 top-3.5 h-4 w-4 text-cinema-gray" />
              </div>
              <button
                type="submit"
                className="rounded-full bg-cinema-red px-6 py-2.5 text-sm font-bold text-cinema-popcorn hover:bg-red-700 transition-all duration-300 shrink-0"
              >
                Assinar
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-1">
              <a href="https://twitter.com" target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-cinema-charcoal bg-cinema-charcoal/20 text-cinema-popcorn/80 hover:border-cinema-gold hover:text-cinema-gold transition-all duration-300" aria-label="Twitter">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-cinema-charcoal bg-cinema-charcoal/20 text-cinema-popcorn/80 hover:border-cinema-gold hover:text-cinema-gold transition-all duration-300" aria-label="Instagram">
              ...
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-cinema-charcoal bg-cinema-charcoal/20 text-cinema-popcorn/80 hover:border-cinema-gold hover:text-cinema-gold transition-all duration-300" aria-label="YouTube">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.517 3.545 12 3.545 12 3.545s-7.517 0-9.388.507a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.871.507 9.388.507 9.388.507s7.517 0 9.388-.507a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://github.com" target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-cinema-charcoal bg-cinema-charcoal/20 text-cinema-popcorn/80 hover:border-cinema-gold hover:text-cinema-gold transition-all duration-300" aria-label="GitHub">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
